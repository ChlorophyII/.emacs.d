...
(custom-set-variables
 ...
 '(package-selected-packages
   '(hl-todo comment-tags tree-sitter-langs tree-sitter graphql graphql-mode ess graphviz-dot-mode pyvenv all-the-icons ebib writeroom-mode fic-mode fill-column-indicator magit move-text multiple-cursors zenburn-theme wc-mode rainbow-mode markdown-mode impatient-mode neotree highlight-parentheses flycheck auctex use-package)))
(custom-set-faces
